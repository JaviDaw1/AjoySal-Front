  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Contacto o dudas</h2>
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Pregunta cualquier duda acerca de nuestra app aquí.  
        </p>
      </div>
      <form action="http://localhost:5173/" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
            ...
            <Switch.Label className="text-sm leading-6 text-gray-600">
              Al seleccionar esto, aceptas nuestra {' '}<br></br>
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-blue-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm  transition-all ease-in-out duration-200 hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Enviar
          </button>
        </div>
