...
const TableBase = ({ recipes = [], onDeleteRecipe }) => {
  ...
  const sortedUsers = [
    ...new Set(recipes.map((recipe) => recipe.user.id)),
  ].sort((a, b) => a - b);
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold leading-6 text-gray-900 mt-4">
            Recipes
          </h1>
                ...
                {sortedRecipes.map(({ userId, recipes }) =>
                  recipes.map((recipe, idx) => (
                    ...
                    >
                      ...
                      <td className="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                        <Link
                          to={`/editrecipe/${recipe.id}?sourcePage=recipeadmin`}
                        >
