        ...
        <main>
          <div className="space-y-8">
            <div className="text-center p-6 bg-white">
              ...
              <a href='/recipeclient' className="bg-blue-500 text-white px-6 py-2 rounded-md shadow-lg transition-all ease-in-out duration-200 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 block w-full lg:w-auto mx-auto lg:mx-0">
                Ver Recetas
              </a>
            </div>
            ...
            {/* Nuevo div con video y texto */}
            <div className="text-center p-3 bg-white">
              <h3 className="text-2xl font-bold mb-4">Tutoriales en Video</h3>
              <p className="text-base mb-4">Descubre nuestros tutoriales en video para aprender nuevas técnicas y recetas.</p>
